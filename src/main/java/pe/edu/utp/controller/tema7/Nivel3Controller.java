...
public class Nivel3Controller {
    ...
    @FXML
    void initialize() {
        code1.getEngine().load(getClass().getResource("/pe/edu/utp/monaco/tema7/t7n3_1.html").toExternalForm());
        code2.getEngine().load(getClass().getResource("/pe/edu/utp/monaco/tema7/t7n3_2.html").toExternalForm());
    ...
    void handleContinueBtnClick(ActionEvent event) throws Exception{
        App.setRoot("tema7/Nivel3Quizz1View");
    }
