...
public class Nivel4Quizz3Controller {
  @FXML
  ...
  void handleConfirmBtnClick(ActionEvent event) {
    ...
    if (input3.getText().equals("cabeza")) {
    ...
    if (input7.getText().equals("siguiente")) {
