...
public class CodegroundController {
  ...
  private Object[][] testCase1 = { { "espada,poción,escudo", "eliminar,1 insertar,0,varita insertar,2,anillo" },
      { "varita,espada,anillo,escudo" } };
  private Object[][] testCase2 = { { "escudo", "insertar,1,espada insertar,0,anillo eliminar,1" },
      { "anillo,espada" } };
