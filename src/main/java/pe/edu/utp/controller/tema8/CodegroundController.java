...
public class CodegroundController {
    ...
    private Object[][] testCase1 = { { "abcdefd", 'd' }, { "dcbaefd" } };
    private Object[][] testCase2 = { { "abc", 'o' }, { "abc" } };
    ...
    void initialize() {
        int tema = 8;
        codeground = new Codeground(new Class[] { String.class, char.class });
